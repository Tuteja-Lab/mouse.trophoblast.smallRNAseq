...
```{r te1, fig.cap="Figure 3A: Differentially expressed proteins (up-regulated in pTGC) enrichment in Mouse ENCODE data", fig.width=8, fig.height=6}
plotTE(unique(diff), myColor = "#c6007b")
```

## TSC

```{r te2, fig.cap="Figure 3B: Differentially expressed proteins (up-regulated in TSC) enrichment in Mouse ENCODE data", fig.width=8, fig.height=6}
plotTE(unique(undiff), myColor = "#a0b600")
```

## pTGC upper quartile

```{r te3, fig.cap="Figure 3C: Upper quartile proteins (pTGC) enrichment in Mouse ENCODE data", fig.width=8, fig.height=6}
plotTE(as.character(diff.75pc$proteinID), "#c6007b")
```

## TSC upper quartile

```{r te5, fig.cap="Figure 3E: Upper quartile proteins (TSC) enrichment in Mouse ENCODE data", fig.width=8, fig.height=6}
...
```{r hmte1, fig.cap="Figure 4A: Heatmaps for E14.5-Brain tissue from the enrichment test using up-regulated proteins of pTGC", fig.width=8, fig.height=4}
plotTE.heatmap.full(
...
```{r hmte2, fig.cap="Figure 4B: Heatmaps for E14.5-Brain tissue from the enrichment test using up-regulated proteins of TSC", fig.width=8, fig.height=2}
plotTE.heatmap.full(

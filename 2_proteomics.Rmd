...
```{r te6, fig.cap="Figure 3F: Top decile proteins (Diff) enrichment in Mouse ENCODE data", fig.width=8, fig.height=6}
...
plotTE.heatmap.full(inputGenes = unique(diff), inputTissue = "E14.5-Placenta", GeneNames = TRUE)
```
...
plotTE.heatmap.full(inputGenes = unique(undiff), inputTissue = "E14.5-Placenta", GeneNames = TRUE)
```

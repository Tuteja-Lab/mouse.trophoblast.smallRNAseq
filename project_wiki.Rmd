...
```{r readstat1, fig.cap="STAR read mapping and feature assignment", fig.width=9, fig.height=7}
...
```{r readstat2, fig.cap="Features with read counts", fig.width=9, fig.height=7}
